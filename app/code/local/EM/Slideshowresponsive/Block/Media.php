<?php
class EM_Slideshowresponsive_Block_Media  extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct($arguments=array())
    {
       parent::__construct($arguments);
	   $this->setTemplate('slideshowresponsive/grid.phtml');
    ...
    {
    	 $pagesGrid = $this->getLayout()->createBlock('slideshowresponsive/media', '', array(
            'id' => $uniqId,
        ));
        $uniqId = Mage::helper('core')->uniqHash($element->getId());
        $sourceUrl = $this->getUrl('slideshowresponsive/admin_chooser/chooser', array('uniq_id' => $uniqId));
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('chooser_id', array(
            'header'    => Mage::helper('slideshowresponsive')->__('File Base Name'),
            'align'     => 'left',
            'index'     => 'basename',
        ));

        $this->addColumn('chooser_title', array(
            'header'    => Mage::helper('slideshowresponsive')->__('File Name'),
            'align'     => 'left',
            'index'     => 'filename',
        ));
    }
    ...
    {
        return $this->getUrl('slideshowresponsive/admin_chooser/chooser', array('_current' => true));
    }
