<?php
class EM_Slideshowresponsive_Admin_ChooserController extends Mage_Adminhtml_Controller_Action
{
    public function chooserAction()
    {
    	...
    	$html =$this->getLayout()->createBlock('slideshowresponsive/content')->toHtml();
